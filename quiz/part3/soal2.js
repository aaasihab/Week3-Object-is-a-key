...
function shoppingTime(memberId, money) {
  ...
  const tokoX = [
    { product: "Sepatu brand Stacattu", price: 1500000 },
    { product: "Baju brand Zoro", price: 500000 },
    { product: "Baju brand H&N", price: 250000 },
    { product: "Sweater brand Uniklooh", price: 175000 },
  ...
  for (const item of tokoX) {
    if (changeMoney >= item.price) {
      listPurchased.push(item.product);
